      ...
      <section className="section-padding bg-white">
        <div className="container-custom">
          <div className="max-w-3xl mx-auto text-center">
            ...
            За защиту прав, достойный труд и социальную справедливость на основе солидарности и равенства.
            </h2>
            <p className="text-gray-600 text-lg mb-8">
            Наш отраслевой профсоюз действует как эффективный посредник между работниками, работодателями и государством, объединяя усилия для создания справедливой, безопасной и социальной трудовой среды, развивая институты коллективной защиты, обучая профсоюзные кадры, формируя политику в интересах трудящихся и обеспечивая активное участие граждан в развитии общества
            </p>
