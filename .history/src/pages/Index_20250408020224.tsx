          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <Card className="card border-t-4 border-t-kazakh-blue">
              <CardContent className="pt-6">
                ...
                <h3 className="text-xl font-bold mb-3">Помогаем в трудных ситуациях</h3>
                <p className="text-gray-600 mb-4">
                Консультируем и представляем интересы в досудебных и судебных спорах, обращаемся в прокуратуру и другие органы.
                </p>
                <Link to="/services" className="text-kazakh-blue font-medium flex items-center gap-1 hover:underline">
                  <span>Learn more</span>
                  <ArrowRight className="h-4 w-4" />
